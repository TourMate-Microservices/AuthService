...
namespace TourMate.AuthService.Repositories.GenericRepository
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        protected TourMateAuthContext _context;
        ...
        public GenericRepository(TourMateAuthContext context)
        {
            _context = context;
        }
